...
{
    [Cmdlet(VerbsLifecycle.Disable, iControlNouns.LTMNodeAddress)]
    public class DisableLTMNodeAddress : iControlPSCmdlet
    {

        #region Parameters

        private string _name = null;
        [Parameter(Position = 0, HelpMessage = "The address of the node to disable")]
					...
					try
					{
						...
						if (index_list.Count > 0)
						{
							...
							for (int j = 0; j < index_list.Count; j++)
							{
								...
								target_enabled_states[j] = iControl.CommonEnabledState.STATE_DISABLED;
							}
							...
							ltmsi.Enabled = iControl.LocalLBEnabledStatus.ENABLED_STATUS_DISABLED;
							ltmsi.Status = "";
							WriteObject(ltmsi);
						}
					}

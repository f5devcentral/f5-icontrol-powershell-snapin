...
{
    [Cmdlet(VerbsLifecycle.Disable, iControlNouns.LTMPoolMember, SupportsShouldProcess = true)]
    public class DisableLTMPoolMember : iControlPSCmdlet
    {
					...
					try
					{
						...
						else
						{
							...
							if (2 == sSplit.Length)
							{
								...
								pmi.Enabled = iControl.LocalLBEnabledStatus.ENABLED_STATUS_DISABLED;
								pmi.Status = "";

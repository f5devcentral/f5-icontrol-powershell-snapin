...
{
    [Cmdlet(VerbsCommon.Remove, iControlNouns.LTMPoolMember, SupportsShouldProcess = true)]
    public class RemoveLTMPoolMember : iControlPSCmdlet
    {
        ...
        [Parameter(Position = 0,
            HelpMessage = "The name of the LTM Pool")]

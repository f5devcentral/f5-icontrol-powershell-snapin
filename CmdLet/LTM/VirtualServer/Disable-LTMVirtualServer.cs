...
{
    [Cmdlet(VerbsLifecycle.Disable, iControlNouns.LTMVirtualServer)]
    public class DisableLTMVirtualServer : iControlPSCmdlet
    {
				...
				if (isInitialized())
				{
					try
					{
						...
						if (index_list.Count > 0)
						{
							...
							si.Enabled = iControl.LocalLBEnabledStatus.ENABLED_STATUS_DISABLED;
							si.Status = "";
